...
<@c.pagination url="${ctx}/dashboard#user/todo" param="definitionKey=${definitionKey}&serialNo=${serialNo}"/>

<script src="${ctx}/static/app/js/dashboard/user/todo/list.js"></script>
