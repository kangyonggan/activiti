...
<div class="tabbable">
    ...
    <div class="tab-content profile-edit-tab-content">
        ...
        <div id="reply-info" class="tab-pane">
            <form id="form" method="post" action="${ctx}/dashboard/manage/todo/${task.taskId}" class="form-horizontal">
                <div class="space-10"></div>
...
<script src="${ctx}/static/app/js/dashboard/manage/todo/detail.js"></script>